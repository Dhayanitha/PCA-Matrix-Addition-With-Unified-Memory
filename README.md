...
```
## Output:
![expt4](https://github.com/Dhayanitha/PCA-Matrix-Addition-With-Unified-Memory/assets/75235032/47d68927-5211-40d8-883a-ca4cf747d04e)
## Result:
The initialization process was completed in 0.453756 seconds, and the matrix addition took 0.03493 seconds in the host, and 0.023408 seconds in the GPU and provides better performance among the host and GPU. Thus, matrix addition using CUDA programming with unified memory has been performed successfully.
